...
For the golden justfile template, detailed syntax reference, advanced patterns, and troubleshooting, see [.agentsmesh/skills/justfile-expert/REFERENCE.md](./REFERENCE.md).