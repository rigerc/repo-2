...
See **`.agentsmesh/skills/agentsmesh/references/configuration.md`** for full field documentation and `agentsmesh.local.yaml` patterns.
...
`.agentsmesh/rules/_root.md` is always applied to every tool (no frontmatter needed, or add `root: true`).
...
- Generated artifacts: `.claude/`, `.cursor/`, `.agentsmesh/rules/_root.md`, etc. — **CLI writes these**
...
Not every target supports every feature. Run `agentsmesh matrix` to see the full compatibility table, or see **`.agentsmesh/skills/agentsmesh/references/targets.md`** for the detailed support matrix.
...
- **`.agentsmesh/skills/agentsmesh/references/configuration.md`** — Full `agentsmesh.yaml` spec, `agentsmesh.local.yaml`, extends, collaboration strategies, conversion options
- **`.agentsmesh/skills/agentsmesh/references/canonical-features.md`** — Complete frontmatter fields for rules, agents, commands, skills, hooks, mcp, permissions
- **`.agentsmesh/skills/agentsmesh/references/targets.md`** — Feature support matrix for all 15 tools, plugin development guide, programmatic API